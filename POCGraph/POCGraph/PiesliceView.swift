        ...
        GeometryReader { geometry in
            ZStack {
                Path { path in
                    ...
                    path.addArc(center: CGPoint(x: width * 0.5, y: height * 0.5), radius: width * 0.5, startAngle: Angle(degrees: -180.0) + pieSliceData.startAngle, endAngle: Angle(degrees: -180.0) + pieSliceData.endAngle, clockwise: false)
